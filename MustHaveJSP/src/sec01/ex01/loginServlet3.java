...
@WebServlet("/login3")//맵핑 이름을 톰캣에게 알려주기 위한 어노테이션 기호 @WebServlet
...
public class loginServlet3 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		doHandle(request, response);//doHandle메소드를 호출하면 doPost에서도 처리가 가능하고
	}
	
	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("doGet메소드 호출됨");
		doHandle(request, response);// doGet메소드 내부에서도 처리가 가능하다.
	}
	...
	protected void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("doHndle메소드 호출됨");
