...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    	...
    	<jsp:setProperty  name="mBean" property="id" param="id"/><!-- param 속성에 input태그의 name속성명을 적어주면 자동으로 input태그의 value값이 들어온다 -->
    	<jsp:setProperty  name="mBean" property="pwd" param="pwd"/>
    	<jsp:setProperty  name="mBean" property="name" param="name"/>
    	<jsp:setProperty  name="mBean" property="email" param="email"/>
