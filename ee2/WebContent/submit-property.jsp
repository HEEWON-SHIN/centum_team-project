                                            ...
                                            <div class="col-sm-12 padding-top-15">                                                   
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="span2" value="" data-slider-min="0" 
                                                               ...
                                                               data-slider-value="[250,450]" id="min-bed"  name="min_bed"><br />
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="span2" value="" data-slider-min="0" 
                                                               data-slider-max="600" data-slider-step="5" 
                                                               data-slider-value="[250,450]" id="min-baths" name="min_bath"><br />
                                                        <b class="pull-left color">1</b> 
                                                        <b class="pull-right color">120</b>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="span2" value="" data-slider-min="0" 
                                                               data-slider-max="600" data-slider-step="5" 
                                                               data-slider-value="[50,450]" id="property-geo" name="geo"><br />
                                            ...
                                            <div class="col-sm-12 padding-top-15">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="exit"> Emergency Exit
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>                                                 
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="sinks"> Dual Sinks 
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div> 
