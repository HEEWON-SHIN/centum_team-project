      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <form class="text-left clearfix"
           		action="${contextPath}/member/signin.do" 
           		method="post"
           		id="formplus"
            ...
            <div class="form-group">
              ...
              <input type="button" value="email중복확인" class="eCheck" name="Emails" id="Emails">
               	<div id="emailok" style="color:red;">이메일 중복확인을 해주세요!</div>
            </div>
          ...
          <p class="mt-20"> 계정이 있으신가요?<a href="${contextPath}/member/prevlogin.do"> Login</a></p>
          <p><a href="${contextPath}/forget-password.jsp"> 비밀번호를 잊어버리셨나요?</a></p>
        </div>
      </div>
...
<%------------------------------------------------ js페이지 ---------------------%>
<script type="text/javascript" src="${contextPath}/js/joinCheck.js"></script>
<%------------------------------------------------ js페이지 ---------------------%>
